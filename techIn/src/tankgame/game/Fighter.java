...
public class Fighter {
    ...
    Fighter(float x, float y, float vx, float vy, float angle, BufferedImage img, String player, Fighter otherPlayer) {
        this.x = x;
        this.y = y;
        this.vx = vx;
        this.vy = vy;
    ...
    Fighter(float x, float y, float vx, float vy, float angle, BufferedImage img, String player) {
        this.x = x;
        this.y = y;
        this.vx = vx;
        this.vy = vy;
    ...
    public void setOtherPlayer(Fighter otherPlayer) {
        this.otherPlayer = otherPlayer;
    }
   ...
   public void pressed(Input dir) {
    ...
    private void kick() {
        ...
        if ("player1".equals(player)) {
            ...
            if (this.crouching) {
                ...
                try {
                    this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("LeftDuckKick_0003.png"));
                } catch (IOException e) {
            ...
            try {
                this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("LeftStandingKick_0005.png"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            if (!otherPlayer.getJumping()) {
        ...
        if ("player2".equals(player)) {
            ...
            if (this.crouching) {
                ...
                try {
                    this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("RightDuckKick_0003.png"));
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
            ...
            try {
                this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("RightStandingKick_0005.png"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
            if (!otherPlayer.getJumping()) {
    ...
    private void punch() {
        ...
        if ("player1".equals(player)) {
            ...
            if (this.jumping) {
                ...
                try {
                    this.img = ImageIO.read(Objects.requireNonNull(Fighter.class.getClassLoader().getResource("LeftJumpPunch_0002.png")));
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
            ...
            if (this.crouching) {
                ...
                try {
                    this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("LeftDuckPunch_0002.png"));
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
            ...
            try {
                this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("LeftStandingPunch_0003.png"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
        ...
        if ("player2".equals(player)) {
            ...
            if (this.jumping) {
                ...
                try {
                    this.img = ImageIO.read(Objects.requireNonNull(Fighter.class.getClassLoader().getResource("RightJumpPunch_0002.png")));
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
            ...
            if (this.crouching) {
                ...
                try {
                    this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("RightDuckPunch_0002.png"));
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
            ...
            try {
                this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("RightStandingPunch_0003.png"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
    ...
    private void crouch() {
        ...
        if ("player1".equals(player)) {
            try {
                this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("LeftDuckIdle.png"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
        ...
        if  ("player2".equals(player)) {
            try {
                this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("RightDuckIdle.png"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
    ...
    private void jump() {
        ...
        if ("player1".equals(player) && !this.moving) {
            ...
            try {
                this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("LeftJumpIdle_0003.png"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
        }
        ...
        if  ("player2".equals(player) && !this.moving) {
            ...
            try {
                this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("RightJumpIdle_0003.png"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public void collisionCheck(Fighter toCheck) {
        if ("player1".equals(this.player)) {
    ...
    public void stand() {
        if ("player1".equals(this.player)) {
            try {
                this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("LeftStandIdle_0001.png"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
        }
        ...
        if ("player2".equals(this.player)) {
            try {
                this.img = ImageIO.read(Fighter.class.getClassLoader().getResource("RightStandIdle_0001.png"));
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
        }
