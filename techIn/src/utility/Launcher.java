...
public class Launcher {
    ...
    public Launcher() {
        ...
        this.jf.setTitle("Tech-In"); // setting the title of the JFrame window.
    ...
    private void initUIComponents() {
        ...
        this.mainPanel.add(gamePanel, "gameObjects"); // add the game panel to the main panel
    ...
    public void resetGame() {
        ...
        mainPanel.add(gamePanel, "gameObjects");
        setFrame("start");
